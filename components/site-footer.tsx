    ...
    <div className="page-shell grid gap-12 py-16 md:grid-cols-[1.3fr_.7fr] md:py-24">
      ...
      <div className="flex flex-col justify-between border-l border-white/15 pl-7">
        ...
        <div className="mt-16 grid grid-cols-2 gap-4 text-sm">
          {[["About","/about"],["Breast conservation","/breast-conservation"],["Clinical work","/clinical-work"],["Innovation","/innovation"],["Research","/research"],["Electives","/teaching"],["Fellowship","/fellowship"],["Media & articles","/media-articles"],["Contact","/contact"]].map(([l,h]) => <Link key={h} href={h} className="text-[#e2e8e3] transition-colors hover:text-white">{l}</Link>)}
        </div>
      </div>
    </div>
